...
wir in diesem Dokument, einige Tipps und Tricks weiter­zu­geben, um im IT-Dschungel einigermassen gesund überleben zu
können.

Dieses Dokument ist weder abschliessend noch vollständig, was die Apps und Tools betrifft. Viel mehr ist dies der
...
Googelst du noch oder unterhältst du dich schon mit einem Chat Bot? Nebst den Chat Bots der grossen Player gibt es
...
Virtual Private Network (VPN) erlaubt eine sichere, verschlüsselte Internet-Verbindung, indem der Internetverkehr über
...
missbraucht wird. Alternativ hilft dir eine VPN-Verbindung, um z.B. eine geschützte, sichere Internet-Verbindung zu
